...
public class ProductCreateRequest {
    ...
    @NotNull(message = "初期在庫数は必須です")
    @Min(value = 0, message = "初期在庫数は0以上で入力してください")
    ...
    public ProductCreateRequest(String name, BigDecimal price, Integer initialStock, String operatorName) {
        this.name = name;
        this.price = price;
